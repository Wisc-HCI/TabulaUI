/*
 * This is Unity's ScrollRect script modified for right clicking instead of left clicking
 *  https://github.com/Unity-Technologies/uGUI/blob/2019.1/UnityEngine.UI/UI/Core/ScrollRect.cs
 *  drawn from Unity's uGUI repository: https://github.com/Unity-Technologies/uGUI
 * 
 *  The relevant commit hash is 5ab4c0fee7cd5b3267672d877ec4051da525913c
 *
 *  The code is licensed under the Unity Companion license. The license can be
 *  found in the third_party_licenses.txt under "uGUI".
 */
...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public class RightClickScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        protected RightClickScrollRect()
        {}
